...
Macros are server-side recipes that translate a short name + query into a fully-formed search URL for a target site. They work in both modes (CLI and Remote) because they're part of the upstream server.
